import BrowserNeu from "../blocks/BrowserNeu";

export const BROWSERNEU = {
  html: `<div class="mockup neu">
        <div class="browser-mockup neu">
...
.neu::before {
    ...
    box-shadow: 0 0 0 2px #183153, 1.5em 0 0 2px #183153, 3em 0 0 2px #183153;
}
