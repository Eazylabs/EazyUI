import CollapseNeu from "../blocks/CollapseNeu";

export const COLLAPSENEU = {
  html: `<div class="collapse">
  <button type="button" class="btn neu collapse-btn">Open Collapse</button>
  <div class="collapse-content neu">
