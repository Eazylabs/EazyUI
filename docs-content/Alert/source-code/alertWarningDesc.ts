import AlertWarningDesc from '../blocks/AlertWarningDesc';

export const ALERTWARNINGDESC = {
  html: `<div className="alert-desc alert-desc-warning">
  <svg
