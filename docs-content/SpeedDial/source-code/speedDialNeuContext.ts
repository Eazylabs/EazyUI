import SpeedDialNeuContext from '../blocks/SpeedDialNeuContext';

export const SPEEDDIALNEUCONTEXT = {
  ...
  <div class='speeddial-menu context neu'>
    <ul>
      <li>item 1</li>
      <li>item 2</li>
      <li>item 3</li>
