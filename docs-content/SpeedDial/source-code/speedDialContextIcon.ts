import SpeedDialContextIcon from '../blocks/SpeedDialContextIcon';

export const SPEEDDIALCONTEXTICON = {
  html: `<div className='speeddial'>
  <button className='speeddial-btn'>
  ...
  <div className='speeddial-menu context'>
    <ul>
      <li>
