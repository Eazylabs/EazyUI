import ModalBasicNeu from '../blocks/ModalBasicNeu';

export const MODALBASICNEU = {
  html: `<button class="btn btn-neu">
  Click Me
</button>; 
<dialog class='dialog dialog-neu'>
